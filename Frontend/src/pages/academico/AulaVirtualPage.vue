  ...
  <q-page class="q-pa-md animate-fade" style="padding-bottom:100px">
    ...
    <div class="row items-center justify-between q-mb-xl rac-page-header" v-if="!materiaActiva">
      <div class="row items-center">
        ...
        <div>
          <div class="font-mono text-grey-6 uppercase tracking-widest" style="font-size:10px">EDUCACIÓN AERONÁUTICA COMPUTARIZADA · LMS · RAC 141</div>
          <h1 class="text-h4 text-weight-bolder text-white font-head q-my-none">Aula Virtual</h1>
        </div>
      </div>
    </div>
