  ...
  <q-page class="q-pa-md animate-fade" style="padding-bottom:120px">
    ...
    <div class="row items-center justify-between q-mb-xl rac-page-header">
      <div class="row items-center">
        ...
        <div>
          <div class="font-mono text-grey-6 uppercase tracking-widest" style="font-size:10px">REPORTE TÉCNICO DE MISIÓN · RAC 61 / 91.417 · UAEAC</div>
...
.border-red-glow { border: 1px solid rgba(161, 11, 19, 0.5); box-shadow: 0 0 40px rgba(161, 11, 19, 0.2); }
