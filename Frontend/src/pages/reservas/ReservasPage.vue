  ...
  <q-page class="q-pa-md animate-fade" style="padding-bottom:100px">
    ...
    <div class="row items-center justify-between q-mb-xl rac-page-header">
      <div class="row items-center">
        ...
        <div>
          <div class="font-mono text-grey-6 uppercase tracking-widest" style="font-size:10px">GESTIÓN DE SLOTS Y DESPACHO · RAC 141.201</div>
          <h1 class="text-h4 text-weight-bolder text-white font-head q-my-none">Despacho de Reservas</h1>
        </div>
      </div>
