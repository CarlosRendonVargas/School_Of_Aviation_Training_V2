...
return [
    ...
    'custom' => [
        'aeronave_id'    => ['required' => 'Debe seleccionar una aeronave.'],
        'estudiante_id'  => ['required' => 'Debe seleccionar un estudiante.', 'exists' => 'El estudiante seleccionado no existe.'],
        'instructor_id'  => ['exists' => 'El instructor seleccionado no existe.'],
        'fecha'          => [
            'required'        => 'La fecha es obligatoria.',
            'date'            => 'La fecha no es válida.',
            'after_or_equal'  => 'La fecha programada debe ser hoy o una fecha futura.',
        ],
        'hora_inicio'    => [
        ...
        'hora_fin'       => [
            ...
            'date_format' => 'La hora de finalización debe estar en formato HH:MM.',
            'after'       => 'La hora de finalización debe ser posterior a la hora de inicio.',
        ],
        'tipo'           => ['required' => 'Debe seleccionar una modalidad de entrenamiento.'],
        'nota'           => ['required' => 'La nota es obligatoria.', 'numeric' => 'La nota debe ser un número.'],
        'programa_id'    => ['required' => 'Debe seleccionar un programa.', 'exists' => 'El programa seleccionado no existe.'],
    ],
